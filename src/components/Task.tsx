...
export function Task({ title, isCompletedTask, isOverdueTask, onClick }: TaskProps) {
    const [openModalCancel, setOpenModalCancel] = useState(false);

    return (
        <>
            <div className={`flex border border-gray02 rounded-[9px] p-4 justify-between max-w-[47.5rem]
